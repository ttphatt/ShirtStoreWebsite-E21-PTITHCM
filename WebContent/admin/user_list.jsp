	...
	<div class="background-div-content">
		<div class="container mb-5 mt-5">
			...
			<div class="row justify-content-center text-center mb-5 mt-4">
				<h3><a href="user_form.jsp" class="btn custom-btn-cart fs-4">Create new User</a></h3>
			</div>
						...
						<tr>
							...
							<td class="align-middle justify-content-center text-center">
								<c:if test="${sessionScope.userEmail eq user.email}">
									<a href="edit_user?id=${user.userId}" class="btn custom-btn-details w-25">Edit</a>	&nbsp;
								</c:if>

								<c:if test="${sessionScope.userEmail ne user.email}">
									<a href="edit_user?id=${user.userId}" class="btn custom-btn-details w-25">Edit</a>	&nbsp;
									<a href="javascript:void(0)" class="deleteLink btn custom-btn-delete w-25" id="${user.userId}">Delete</a> &nbsp;
								</c:if>
							</td>
						</tr>
					</c:forEach>
