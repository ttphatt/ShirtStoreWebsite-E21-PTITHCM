	...
	<div class="background-div-content">
		<div class="container mb-5 mt-5">
			...
			<div class="row text-center mt-5">
				<h3><a href="type_form.jsp" class="btn custom-btn-cart fs-4">Create new Type</a></h3>
			</div>
					...
					<c:forEach var="type" items="${listType}" varStatus="status">
						<tr>
							...
							<td class="align-middle justify-content-center text-center">
								<a href="edit_type?id=${type.typeId}" class="btn custom-btn-details w-25">Edit</a>	&nbsp;
								<a href="javascript:void(0)" class="deleteLink btn custom-btn-delete w-25 text-center" id="${type.typeId}">Delete</a> &nbsp;
							</td>
						</tr>
					</c:forEach>
					</tbody>
