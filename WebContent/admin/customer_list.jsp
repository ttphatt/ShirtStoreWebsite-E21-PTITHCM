					...
					<c:forEach var="customer" items="${listCustomer}" varStatus="status">
						<tr>
							...
							<td class="align-middle justify-content-center text-center">
								<a href="edit_customer?id=${customer.customerId}" class="btn custom-btn-details">Edit</a>	&nbsp;
								<a href="javascript:void(0)" class="deleteLink btn custom-btn-delete" id="${customer.customerId}">Delete</a> &nbsp;
							</td>
						</tr>
					</c:forEach>
					</tbody>
