        ...
        <div class="row align-items-center justify-content-between" style="font-family: 'Roboto', sans-serif">
            <div class="col-md-5 d-flex align-items-center">
                <a href="${pageContext.request.contextPath}" style="text-decoration: none; color: #0c0c0c">
                    <h1 class="display-5"><img src="images/shirt-logo-black.png" style="max-height: 100px" class="img-fluid">The Shirt Store</h1>
                </a>
                <%--                <h1 class="ms-3">--%>
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-end">
                <div class="dropdown custom-dropdown me-2">
                    <button class="btn btn-outline-primary dropdown-toggle" type="button" id="categoryMenu" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: large">
                        Categories
                    </button>
                ...
                <c:if test="${loggedCustomer != null}">
                    <div class="dropdown custom-dropdown">
                        <button class="btn btn-dark dropdown-toggle" type="button" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: large">
                            Hi there, ${loggedCustomer.fullName}
                        </button>
                ...
                <a href="view_cart" class="btn custom-btn-cart ms-2" style="font-size: large"><img src="images/online-shopping.png" style="max-height: 20px;"></img>&nbsp;&nbsp;Cart</a>
            </div>
        </div>
        <br>
