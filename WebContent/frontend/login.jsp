...
<div class="background-div-content">
    <div class="container mb-5">
            ...
            <div class="col-md-6 border custom-border" style="border-radius: 20px; padding: 25px">
                <form id="formLogin" action="login" method="post">
                    ...
                    <div class="mb-5 text-start">
                        <a href="reset_password" class="custom-btn-delete" style="text-decoration: none; border-radius: 10px">Forgot Password</a>
                    </div>
        ...
        <div class="row justify-content-center text-center mt-3">
            <div class="col-md-6">
                <%--                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/ShirtStoreWebsite/login&response_type=code&client_id=734161680008-sol644a9hji09b12fe6hiev3p4f7cg74.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger btn-custom">--%>
                <%--                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">--%>
                <%--                            <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>--%>
                <%--                        </svg>--%>
                <%--                        <span class="ms-2 fs-6">Sign in with Google</span>--%>
